...
You may not grant any further license to the Code beyond the rights expressly stated herein. In particular, you may not sublicense the Code (in source or binary form) to any third party.

---

## 7. Trademarks

This License does **not** grant you any rights to use the author’s or repository owner’s trademarks, service marks, logos, or trade names (including “KyanberuGames” or “Cassette BBQ!”). All such marks remain the sole property of the repository owner.

---

## 8. Termination

This License and the rights granted hereunder will terminate **immediately** and automatically if you fail to comply with any of its terms (including Sections 3 “Conditions,” 6 “No Sublicensing,” or 7 “Trademarks”). Upon termination, you must:

1. **Cease** all use of the Code.  
...
This License is governed by and construed in accordance with the laws of **England and Wales** (with no regard to its conflict‑of‑law provisions). Any dispute arising under or related to this License shall be subject to the exclusive jurisdiction of the courts of England and Wales.

---

## 10. Third‑Party Components

The Code may incorporate third‑party components (e.g., Unity engine, Unity asset plugins) that are themselves licensed under separate terms. You must abide by those original licenses for those components. Nothing in this License overrides or supersedes any such third‑party license.
